...
public class Main {
  ...
  /**
   * This class allows to choose what class to run
   * by entering the number assigned to it.
   * @param args the menu selection.
   * @throws java.lang.Exception error message for wrong inputs.
   */
